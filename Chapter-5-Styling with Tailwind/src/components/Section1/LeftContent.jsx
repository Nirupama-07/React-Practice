...
const LeftContent = () => {
  return (
    ...
    <div className="absolute inset-0 bg-black/10"></div>
      ...
      <button className='relative z-10 mt-5 p-2 w-40.5 bg-transparent border-2 border-white text-white px-6 py-2 rounded-lg hover:cursor-pointer'>Discover Now</button>
    </div>
  )
}
